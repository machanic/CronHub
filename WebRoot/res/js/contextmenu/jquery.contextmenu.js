...
;(function($){
	$.contextMenu = {
		...
		createMenuItem: function(label,obj) {
			...
			// add the id attribute for menuitem
			var $div = $('<div id="'+o.id+'" class="'+cmenu.itemClassName+' '+o.className+((o.disabled)?' '+cmenu.disabledItemClassName:'')+'" title="'+o.title+'"></div>')
		...
		show: function(t,e) {
			$('.context-menu-selected').removeClass('context-menu-selected'); // cancel selected
			var cmenu=this, x=e.pageX, y=e.pageY;
			cmenu.target = t; // Preserve the object that triggered this context menu so menu item click methods can see it
			$('.context-menu-item').removeClass('context-menu-item-disabled'); // cancel the disabled item before show
			if (cmenu.beforeShow(this.target)!==false) { // use the target as beforeShow function parameter
				...
				cmenu.shown=true;
				$(this.target).addClass('context-menu-selected'); // add selected
