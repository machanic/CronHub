...
public class ExecutorService {
  ...
  public interface Iface {
    ...
    public ExecuteDoneReportResult executeCmd(String cmd, long task_id, boolean undoReportHttp, String undoReportHttpUrl, int exec_type, boolean delTempFile) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void executeCmd(String cmd, long task_id, boolean undoReportHttp, String undoReportHttpUrl, int exec_type, boolean delTempFile, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.executeCmd_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public ExecuteDoneReportResult executeCmd(String cmd, long task_id, boolean undoReportHttp, String undoReportHttpUrl, int exec_type, boolean delTempFile) throws org.apache.thrift.TException
    {
      send_executeCmd(cmd, task_id, undoReportHttp, undoReportHttpUrl, exec_type, delTempFile);
      return recv_executeCmd();
    }

    public void send_executeCmd(String cmd, long task_id, boolean undoReportHttp, String undoReportHttpUrl, int exec_type, boolean delTempFile) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void executeCmd(String cmd, long task_id, boolean undoReportHttp, String undoReportHttpUrl, int exec_type, boolean delTempFile, org.apache.thrift.async.AsyncMethodCallback<executeCmd_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      executeCmd_call method_call = new executeCmd_call(cmd, task_id, undoReportHttp, undoReportHttpUrl, exec_type, delTempFile, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class executeCmd_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public executeCmd_call(String cmd, long task_id, boolean undoReportHttp, String undoReportHttpUrl, int exec_type, boolean delTempFile, org.apache.thrift.async.AsyncMethodCallback<executeCmd_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor implements org.apache.thrift.TProcessor {
    ...
    private static class executeCmd<I extends Iface> extends org.apache.thrift.ProcessFunction<I, executeCmd_args> {
      ...
      protected executeCmd_result getResult(I iface, executeCmd_args args) throws org.apache.thrift.TException {
        executeCmd_result result = new executeCmd_result();
        result.success = iface.executeCmd(args.cmd, args.task_id, args.undoReportHttp, args.undoReportHttpUrl, args.exec_type, args.delTempFile);
        return result;
      }
    }
        ...
        switch (field.id) {
          ...
          case 3: // UNDO_REPORT_HTTP
            if (field.type == org.apache.thrift.protocol.TType.BOOL) {
              this.undoReportHttp = iprot.readBool();
              setUndoReportHttpIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            }
          ...
          case 4: // UNDO_REPORT_HTTP_URL
            if (field.type == org.apache.thrift.protocol.TType.STRING) {
              this.undoReportHttpUrl = iprot.readString();
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            }
            break;
          ...
          case 6: // DEL_TEMP_FILE
            if (field.type == org.apache.thrift.protocol.TType.BOOL) {
              this.delTempFile = iprot.readBool();
              setDelTempFileIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            }
  ...
  public static class update_args implements org.apache.thrift.TBase<update_args, update_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (field.id) {
          case 1: // UPDATE_SHELL_CMD
            if (field.type == org.apache.thrift.protocol.TType.STRING) {
              this.updateShellCmd = iprot.readString();
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
      ...
      if (this.updateShellCmd != null) {
        ...
        oprot.writeString(this.updateShellCmd);
        oprot.writeFieldEnd();
      }
      oprot.writeFieldStop();
      oprot.writeStructEnd();
